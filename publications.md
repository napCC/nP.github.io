...
1. **ShotDirector: Directorially Controllable Multi-Shot Video Generation with Cinematographic Transitions**
   Xiaoxue Wu, **Xinyuan Chen**, Yaohui Wang, Yu Qiao
   *CVPR 2026*
   [[Paper](https://arxiv.org/abs/2512.10286)] [[Project Page](https://uknowsth.github.io/ShotDirector/)]

2. **VDOT: Efficient Unified Video Creation via Optimal Transport Distillation**
   Yaohui Wang, Haiyu Zhang, Tianfan Xue, Yu Qiao, Yi Wang, Cunjian Chen, **Xinyuan Chen**
   *CVPR 2026*
   [[Paper](https://arxiv.org/abs/2512.06802)] [[Project Page](https://vdot-page.github.io/)] [[Code](https://github.com/hhhh1138/VDOT)]

3. **CineTrans: Learning to Generate Videos with Cinematic Transitions via Masked Diffusion Models**
   Xiaoxue Wu, Bingjie Gao, Yu Qiao, Yaohui Wang, **Xinyuan Chen**
   *ICLR 2026*
   [[Paper](https://arxiv.org/abs/2508.11484)] [[Project Page](https://uknowsth.github.io/CineTrans/)] [[Code](https://github.com/Vchitect/CineTrans)]

4. **Consistent and Controllable Image Animation with Motion Linear Diffusion Transformers**
...
1. **Vchitect-2.0: Parallel Transformer for Scaling Up Video Diffusion Models**
   ...
   *arXiv:2501.08453*, 2025
   [[Paper](https://arxiv.org/abs/2501.08453)] [[Code](https://github.com/Vchitect/Vchitect-2.0)]
...
2. **VBench++: Comprehensive and Versatile Benchmark Suite for Video Generative Models**
   ...
   *IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)*, 2025
   [[Paper](https://arxiv.org/abs/2411.13503)] [[Code](https://github.com/Vchitect/VBench)]

3. **Cinemo: Consistent and Controllable Image Animation with Motion Diffusion Models**
...
4. **Leo: Generative Latent Image Animator for Human Video Synthesis**
   Yaohui Wang, Xin Ma, **Xinyuan Chen**, Cunjian Chen, Antitza Dantcheva, Bo Dai, Yu Qiao
   *International Journal of Computer Vision (IJCV)*, 2025
   [[Paper](https://arxiv.org/abs/2305.03989)] [[Project Page](https://wyhsirius.github.io/LEO-project/)] [[Code](https://github.com/wyhsirius/LEO)]

5. **Ouroboros3D: Image-to-3D Generation via 3D-Aware Recursive Diffusion**
   Hao Wen, Ziqi Huang, Yaohui Wang, **Xinyuan Chen**, Lu Sheng
   *CVPR 2025*
   [[Paper](https://arxiv.org/abs/2406.03184)] [[Project Page](https://costwen.github.io/Ouroboros3D/)] [[Code](https://github.com/Costwen/Ouroboros3D)]

6. **The Devil Is in the Prompts: Retrieval-Augmented Prompt Optimization for Text-to-Video Generation**
   Bingjie Gao, Xinyu Gao, Xiaoxue Wu, Yujie Zhou, Yu Qiao, Li Niu, **Xinyuan Chen**, Yaohui Wang
   *CVPR 2025*
   [[Paper](https://arxiv.org/abs/2504.11739)] [[Project Page](https://whynothaha.github.io/Prompt_optimizer/RAPO.html)]

7. **Vinci: A Real-time Smart Assistant Based on Egocentric Vision-Language Model for Portable Devices**
...
9. **AccVideo: Accelerating Video Diffusion Model with Synthetic Dataset**
   Haiyu Zhang, **Xinyuan Chen**, Yaohui Wang, Xihui Liu, Yunhong Wang, Yu Qiao
   *arXiv:2503.19462*, 2025
   [[Paper](https://arxiv.org/abs/2503.19462)] [[Project Page](https://aejion.github.io/accvideo/)] [[Code](https://github.com/aejion/AccVideo)]

10. **Diff-TST: Diffusion Model for One-Shot Text-Image Style Transfer**
    Sizhe Pang, **Xinyuan Chen**, Yangchen Xie, Hongjian Zhan, Bing Yin, Yue Lu
    *Expert Systems with Applications*, vol. 263, 125747, 2025

11. **An Egocentric Vision-Language Model Based Portable Real-time Smart Assistant**
...
12. **Lia-X: Interpretable Latent Portrait Animator**
    Yaohui Wang, Di Yang, **Xinyuan Chen**, Francois Bremond, Yu Qiao, Antitza Dantcheva
    *arXiv:2508.09959*, 2025
    [[Paper](https://arxiv.org/abs/2508.09959)] [[Project Page](https://wyhsirius.github.io/LIA-X-project/)] [[Code](https://github.com/wyhsirius/LIA-X)]

13. **GenHOI: Generalizing Text-driven 4D Human-Object Interaction Synthesis for Unseen Objects**
    Shujia Li, Haiyu Zhang, **Xinyuan Chen**, Yaohui Wang, Yixing Ban
    *arXiv:2506.15483*, 2025
    [[Paper](https://arxiv.org/abs/2506.15483)] [[Project Page](https://etach-qs.github.io/GenHOI_project/)] [[Code](https://github.com/etach-qs/GenHOI)]

14. **Training-Free Stylized Text-to-Image Generation with Fast Inference**
    Xin Ma, Yaohui Wang, **Xinyuan Chen**, Tien-Tsin Wong, Cunjian Chen
    *arXiv:2505.19063*, 2025

15. **RAPO++: Cross-Stage Prompt Optimization for Text-to-Video Generation via Data Alignment and Test-Time Scaling**
    ...
    *arXiv:2510.20206*, 2025
    [[Paper](https://arxiv.org/abs/2510.20206)] [[Project Page](https://whynothaha.github.io/RAPO_plus_github/)] [[Code](https://github.com/Vchitect/RAPO)]
...
1. **Latte: Latent Diffusion Transformer for Video Generation**
   ...
   *TMLR 2025*
   [[Paper](https://arxiv.org/abs/2401.03048)] [[Project Page](https://maxin-cn.github.io/latte_project/)] [[Code](https://github.com/Vchitect/Latte)]

2. **VBench: Comprehensive Benchmark Suite for Video Generative Models**
...
3. **SinSR: Diffusion-Based Image Super-Resolution in a Single Step**
   Yufei Wang, Wenhan Yang, **Xinyuan Chen**\*, Yaohui Wang, Lanqing Guo, Lap-Pui Chau, Ziwei Liu, Yu Qiao
   *CVPR 2024*
   [[Paper](https://arxiv.org/abs/2311.14760)] [[Code](https://github.com/wyf0912/SinSR)]

4. **Vlogger: Make Your Dream A Vlog**
   Shaobin Zhuang, Kunchang Li, **Xinyuan Chen**\*, Yaohui Wang\*, Ziwei Liu, Yu Qiao, Yali Wang\*
   *CVPR 2024*
   [[Paper](https://arxiv.org/abs/2401.09414)] [[Project Page](https://zhuangshaobin.github.io/Vlogger.github.io/)] [[Code](https://github.com/Vchitect/Vlogger)]

5. **4Diffusion: Multi-view Video Diffusion Model for 4D Generation**
   Haiyu Zhang, **Xinyuan Chen**, Yaohui Wang, Xihui Liu, Yunhong Wang, Yu Qiao
   *NeurIPS 2024*
   [[Paper](https://arxiv.org/abs/2405.20674)] [[Project Page](https://aejion.github.io/4diffusion/)] [[Code](https://github.com/aejion/4Diffusion)]

6. **EpiDiff: Enhancing Multi-View Synthesis via Localized Epipolar-Constrained Diffusion**
   Zehuan Huang, Hao Wen, Junting Dong, Yaohui Wang, Yangguang Li, **Xinyuan Chen**, Yan-Pei Cao, Ding Liang, Yu Qiao, Bo Dai, Lu Sheng
   *CVPR 2024*
   [[Paper](https://arxiv.org/abs/2312.06725)] [[Project Page](https://huanngzh.github.io/EpiDiff/)]

7. **Brush Your Text: Synthesize Any Scene Text on Images via Diffusion Model**
   Lingjun Zhang\*, **Xinyuan Chen**\*, Yaohui Wang, Yue Lu, Yu Qiao
   *AAAI 2024*
   [[Paper](https://arxiv.org/abs/2312.12232)]

8. **ConditionVideo: Training-Free Condition-Guided Video Generation**
   Bo Peng, **Xinyuan Chen**\*, Yaohui Wang, Chaochao Lu, Yu Qiao
   *AAAI 2024*
   [[Paper](https://arxiv.org/abs/2310.07697)] [[Project Page](https://pengbo807.github.io/conditionvideo-website/)] [[Code](https://github.com/pengbo807/ConditionVideo)]

9. **Vinci: A Real-time Embodied Smart Assistant Based on Egocentric Vision-Language Model**
...
10. **Hierarchical Diffusion Autoencoders and Disentangled Image Manipulation**
    Zeyu Lu, Chengyue Wu, **Xinyuan Chen**, Yaohui Wang, Lei Bai, Yu Qiao, Xihui Liu
    *WACV 2024*

11. **Uncertainty-aware Image Inpainting with Adaptive Feedback Network**
...
12. **Combinatorial Progressive Architecture Search for Crowd Counting**
...
1. **SEINE: Short-to-Long Video Diffusion Model for Generative Transition and Prediction**
   **Xinyuan Chen**, Yaohui Wang, Lingjun Zhang, Shaobin Zhuang, Xin Ma, Jiashuo Yu, Yali Wang, Dahua Lin, Yu Qiao, Ziwei Liu
   *ICLR 2024* **Spotlight**
   [[Paper](https://arxiv.org/abs/2310.20700)] [[Project Page](https://vchitect.github.io/SEINE-project/)] [[Code](https://github.com/Vchitect/SEINE)]

2. **LaVie: High-Quality Video Generation with Cascaded Latent Diffusion Models**
   ...
   *IJCV 2024*
   [[Paper](https://arxiv.org/abs/2309.15103)] [[Project Page](https://vchitect.github.io/LaVie-project/)] [[Code](https://github.com/Vchitect/LaVie)]
...
4. **Long-term Rhythmic Video Soundtracker**
   Jiashuo Yu, Yaohui Wang, **Xinyuan Chen**, Xiao Sun, Yu Qiao
   *ICML 2023*
   [[Paper](https://arxiv.org/abs/2305.01319)]

5. **Weakly Supervised Scene Text Generation for Low-Resource Languages**
...
6. **Multi-level Feature Disentanglement Network for Cross-dataset Face Forgery Detection**
...
1. **Cross Attention Based Style Distribution for Controllable Person Image Synthesis**
...
3. **DG-Font++: Robust Deformable Generative Networks for Unsupervised Font Generation**
   **Xinyuan Chen**, Yangchen Xie, Li Sun, Yue Lu
   *arXiv:2212.14742*, 2022
   [[Paper](https://arxiv.org/abs/2212.14742)]

4. **Unsupervised Image Restoration with Quality-Task-Perception Loss**
...
1. **DG-Font: Deformable Generative Networks for Unsupervised Font Generation**
   Yangchen Xie, **Xinyuan Chen**\*, Li Sun, Yue Lu
   *CVPR 2021*
   [[Paper](https://arxiv.org/abs/2104.03064)]

2. **Multi-order Adversarial Representation Learning for Composed Query Image Retrieval**
   Zicheng Fu\*, **Xinyuan Chen**\*, Jiashuo Dong, Sheng Ji
   *ICASSP 2021*

3. **Swin-Spectral Transformer for Cholangiocarcinoma Hyperspectral Image Segmentation**
   Zijun Zhou, Shiqi Qiu, Yaohui Wang, Mei Zhou, **Xinyuan Chen**, Menghan Hu, Qingli Li, Yue Lu
   *ICISP BMEI 2021*

4. **Scene Text Transfer for Cross-Language**
   Lingjun Zhang, **Xinyuan Chen**, Yangchen Xie, Yue Lu
   *International Conference on Image and Graphics (ICIG)*, 2021

5. **Bijective Multi-mode Deraining on Single Image**
   Shiqi Qiu, Wenchao Xu, Li Sun, Guangtao Zhai, **Xinyuan Chen**, Qingli Li
   *ICISP BMEI 2021*

6. **Deformable Generative Networks for Few-shot Cross-Language Font Generation**
...
1. **Long-term Video Prediction via Criticization and Retrospection**
...
1. **Attention-GAN for Object Transfiguration in Wild Images**
   **Xinyuan Chen**, Chang Xu, Xiaokang Yang, Dacheng Tao
   *ECCV 2018*
   [[Paper](https://arxiv.org/abs/1803.06798)]

2. **Gated-GAN: Adversarial Gated Networks for Multi-Collection Style Transfer**
